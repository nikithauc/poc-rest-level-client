...
export interface MicrosoftGraphIdentityUserFlow extends MicrosoftGraphEntity{
   userFlowType?: string
   userFlowTypeVersion?: number | string
   "@odata.type"?: string
}
...
export interface MicrosoftGraphManagedAndroidStoreApp extends MicrosoftGraphManagedApp{
   appStoreUrl?: string
   minimumSupportedOperatingSystem?: {v10_0?: boolean,v11_0?: boolean,v4_0?: boolean,v4_0_3?: boolean,v4_1?: boolean,v4_2?: boolean,v4_3?: boolean,v4_4?: boolean,v5_0?: boolean,v5_1?: boolean,"@odata.type"?: string,}
   packageId?: string
   "@odata.type"?: string
}
...
export interface MicrosoftGraphUserExperienceAnalyticsDevicePerformance extends MicrosoftGraphEntity{
   averageBlueScreens?: number | string
   averageRestarts?: number | string
   ...
   manufacturer?: string
   model?: string
   modelStartupPerformanceScore?: number | string
   operatingSystemVersion?: string
   responsiveDesktopTimeInMs?: number
   restartCount?: number
   startupPerformanceScore?: number | string
   "@odata.type"?: string
}
...
export interface MicrosoftGraphPhoto{
   cameraMake?: string
   cameraModel?: string
   exposureDenominator?: number | string
   exposureNumerator?: number | string
...
export interface MicrosoftGraphDeviceGeoLocation{
   ...
   longitude?: number | string
   speed?: number | string
   verticalAccuracy?: number | string
   "@odata.type"?: string
}
...
export interface MicrosoftGraphTeleconferenceDeviceMediaQuality{
   ...
   averageInboundPacketLossRateInPercentage?: number | string
   averageInboundRoundTripDelay?: string
   averageOutboundJitter?: string
   averageOutboundPacketLossRateInPercentage?: number | string
   ...
   maximumInboundPacketLossRateInPercentage?: number | string
   maximumInboundRoundTripDelay?: string
   maximumOutboundJitter?: string
   maximumOutboundPacketLossRateInPercentage?: number | string
...
export interface MicrosoftGraphTeleconferenceDeviceQuality{
   ...
   deviceName?: string
   mediaLegId?: string
   mediaQualityList?: {averageInboundJitter?: string,averageInboundPacketLossRateInPercentage?: number | string,averageInboundRoundTripDelay?: string,averageOutboundJitter?: string,averageOutboundPacketLossRateInPercentage?: number | string,averageOutboundRoundTripDelay?: string,channelIndex?: number,inboundPackets?: number,localIPAddress?: string,localPort?: number,maximumInboundJitter?: string,maximumInboundPacketLossRateInPercentage?: number | string,maximumInboundRoundTripDelay?: string,maximumOutboundJitter?: string,maximumOutboundPacketLossRateInPercentage?: number | string,maximumOutboundRoundTripDelay?: string,mediaDuration?: string,networkLinkSpeedInBytes?: number,outboundPackets?: number,remoteIPAddress?: string,remotePort?: number,"@odata.type"?: string,}
   participantId?: string
   "@odata.type"?: string
}
export interface MicrosoftGraphTeleconferenceDeviceVideoQuality extends MicrosoftGraphTeleconferenceDeviceMediaQuality{
   averageInboundBitRate?: number | string
   averageInboundFrameRate?: number | string
   averageOutboundBitRate?: number | string
   averageOutboundFrameRate?: number | string
   "@odata.type"?: string
}
...
export interface MicrosoftGraphCallRecordsDeviceInfo{
   ...
   captureNotFunctioningEventRatio?: number | string
   cpuInsufficentEventRatio?: number | string
   deviceClippingEventRatio?: number | string
   deviceGlitchEventRatio?: number | string
   howlingEventCount?: number
   initialSignalLevelRootMeanSquare?: number | string
   lowSpeechLevelEventRatio?: number | string
   lowSpeechToNoiseEventRatio?: number | string
   micGlitchRate?: number | string
   receivedNoiseLevel?: number
   receivedSignalLevel?: number
   renderDeviceDriver?: string
   renderDeviceName?: string
   renderMuteEventRatio?: number | string
   renderNotFunctioningEventRatio?: number | string
   renderZeroVolumeEventRatio?: number | string
   sentNoiseLevel?: number
   sentSignalLevel?: number
   speakerGlitchRate?: number | string
   "@odata.type"?: string
}
...
export interface MicrosoftGraphCallRecordsNetworkInfo{
   bandwidthLowEventRatio?: number | string
   basicServiceSetIdentifier?: string
   connectionType?: string
   delayEventRatio?: number | string
   dnsSuffix?: string
   ipAddress?: string
   linkSpeed?: number
   macAddress?: string
   ...
   port?: number
   receivedQualityEventRatio?: number | string
   reflexiveIPAddress?: string
   relayIPAddress?: string
   relayPort?: number
   sentQualityEventRatio?: number | string
   subnet?: string
...
export interface MicrosoftGraphCallRecordsMediaStream{
   ...
   averageAudioDegradation?: number | string
   averageAudioNetworkJitter?: string
   averageBandwidthEstimate?: number
   averageJitter?: string
   averagePacketLossRate?: number | string
   averageRatioOfConcealedSamples?: number | string
   averageReceivedFrameRate?: number | string
   averageRoundTripTime?: string
   averageVideoFrameLossPercentage?: number | string
   averageVideoFrameRate?: number | string
   averageVideoPacketLossRate?: number | string
   endDateTime?: string
   lowFrameRateRatio?: number | string
   lowVideoProcessingCapabilityRatio?: number | string
   maxAudioNetworkJitter?: string
   maxJitter?: string
   maxPacketLossRate?: number | string
   maxRatioOfConcealedSamples?: number | string
   maxRoundTripTime?: string
   packetUtilization?: number
   postForwardErrorCorrectionPacketLossRate?: number | string
   startDateTime?: string
...
export interface MicrosoftGraphEmailAuthenticationMethodCollectionResponse{
   value?: MicrosoftGraphEmailAuthenticationMethod[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphLongRunningOperationCollectionResponse{
   value?: MicrosoftGraphLongRunningOperation[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPasswordAuthenticationMethodCollectionResponse{
   value?: MicrosoftGraphPasswordAuthenticationMethod[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPhoneAuthenticationMethodCollectionResponse{
   value?: MicrosoftGraphPhoneAuthenticationMethod[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSoftwareOathAuthenticationMethodCollectionResponse{
   value?: MicrosoftGraphSoftwareOathAuthenticationMethod[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphPinnedChatMessageInfoCollectionResponse{
   value?: MicrosoftGraphPinnedChatMessageInfo[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphAssociatedTeamInfoCollectionResponse{
   value?: MicrosoftGraphAssociatedTeamInfo[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphFederatedIdentityCredentialCollectionResponse{
   value?: MicrosoftGraphFederatedIdentityCredential[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphCrossTenantAccessPolicyConfigurationPartnerCollectionResponse{
   value?: {b2bCollaborationInbound?: MicrosoftGraphCrossTenantAccessPolicyB2BSetting,b2bCollaborationOutbound?: MicrosoftGraphCrossTenantAccessPolicyB2BSetting,b2bDirectConnectInbound?: MicrosoftGraphCrossTenantAccessPolicyB2BSetting,b2bDirectConnectOutbound?: MicrosoftGraphCrossTenantAccessPolicyB2BSetting,inboundTrust?: MicrosoftGraphCrossTenantAccessPolicyInboundTrust,isServiceProvider?: boolean,tenantId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphSharedWithChannelTeamInfoCollectionResponse{
   value?: MicrosoftGraphSharedWithChannelTeamInfo[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphDocumentSetVersionCollectionResponse{
   value?: MicrosoftGraphDocumentSetVersion[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphAttachmentBaseCollectionResponse{
   value?: MicrosoftGraphAttachmentBase[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAttachmentSessionCollectionResponse{
   value?: MicrosoftGraphAttachmentSession[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphSecurityEdiscoveryCaseCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryCase[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryCustodianCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryCustodian[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryNoncustodialDataSourceCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryNoncustodialDataSource[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityCaseOperationCollectionResponse{
   value?: MicrosoftGraphSecurityCaseOperation[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryReviewSetCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryReviewSet[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoverySearchCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoverySearch[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryReviewTagCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryReviewTag[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryReviewSetQueryCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryReviewSetQuery[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityDataSourceCollectionResponse{
   value?: MicrosoftGraphSecurityDataSource[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecuritySiteSourceCollectionResponse{
   value?: MicrosoftGraphSecuritySiteSource[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityUnifiedGroupSourceCollectionResponse{
   value?: MicrosoftGraphSecurityUnifiedGroupSource[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityUserSourceCollectionResponse{
   value?: MicrosoftGraphSecurityUserSource[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphCrossTenantAccessPolicyCollectionResponse{
   value?: MicrosoftGraphCrossTenantAccessPolicy[]
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphTaskFileAttachmentCollectionResponse{
   value?: MicrosoftGraphTaskFileAttachment[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryAddToReviewSetOperationCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryAddToReviewSetOperation[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryIndexOperationCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryIndexOperation[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryEstimateOperationCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryEstimateOperation[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryHoldOperationCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryHoldOperation[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityEdiscoveryTagOperationCollectionResponse{
   value?: MicrosoftGraphSecurityEdiscoveryTagOperation[]
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphKeyValueCollectionResponse{
   value?: {key?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphTargetResourceCollectionResponse{
   value?: {displayName?: string,groupType?: MicrosoftGraphGroupType,id?: string,modifiedProperties?: MicrosoftGraphModifiedProperty[],type?: string,userPrincipalName?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphModifiedPropertyCollectionResponse{
   value?: {displayName?: string,newValue?: string,oldValue?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphProvisioningStepCollectionResponse{
   value?: {description?: string,details?: MicrosoftGraphDetailsInfo,name?: string,provisioningStepType?: MicrosoftGraphProvisioningStepType,status?: MicrosoftGraphProvisioningResult,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAppliedConditionalAccessPolicyCollectionResponse{
   value?: {displayName?: string,enforcedGrantControls?: string[],enforcedSessionControls?: string[],id?: string,result?: MicrosoftGraphAppliedConditionalAccessPolicyResult,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAssignedLicenseCollectionResponse{
   value?: {disabledPlans?: string[],skuId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAssignedPlanCollectionResponse{
   value?: {assignedDateTime?: string,capabilityStatus?: string,service?: string,servicePlanId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphObjectIdentityCollectionResponse{
   value?: {issuer?: string,issuerAssignedId?: string,signInType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphLicenseAssignmentStateCollectionResponse{
   value?: {assignedByGroup?: string,disabledPlans?: string[],error?: string,lastUpdatedDateTime?: string,skuId?: string,state?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphOnPremisesProvisioningErrorCollectionResponse{
   value?: {category?: string,occurredDateTime?: string,propertyCausingError?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphProvisionedPlanCollectionResponse{
   value?: {capabilityStatus?: string,provisioningStatus?: string,service?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphServicePlanInfoCollectionResponse{
   value?: {appliesTo?: string,provisioningStatus?: string,servicePlanId?: string,servicePlanName?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphLocationCollectionResponse{
   value?: {address?: MicrosoftGraphPhysicalAddress,coordinates?: MicrosoftGraphOutlookGeoCoordinates,displayName?: string,locationEmailAddress?: string,locationType?: MicrosoftGraphLocationType,locationUri?: string,uniqueId?: string,uniqueIdType?: MicrosoftGraphLocationUniqueIdType,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphEmailAddressCollectionResponse{
   value?: {address?: string,name?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRecipientCollectionResponse{
   value?: {emailAddress?: MicrosoftGraphEmailAddress,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphInternetMessageHeaderCollectionResponse{
   value?: {name?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPhoneCollectionResponse{
   value?: {language?: string,number?: string,region?: string,type?: MicrosoftGraphPhoneType,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphScoredEmailAddressCollectionResponse{
   value?: {address?: string,itemId?: string,relevanceScore?: number | string,selectionLikelihood?: MicrosoftGraphSelectionLikelihoodInfo,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphWebsiteCollectionResponse{
   value?: {address?: string,displayName?: string,type?: MicrosoftGraphWebsiteType,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphDeviceActionResultCollectionResponse{
   value?: {actionName?: string,actionState?: string,lastUpdatedDateTime?: string,startDateTime?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAddInCollectionResponse{
   value?: {id?: string,properties?: {key?: string,value?: string,"@odata.type"?: string,},type?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAppRoleCollectionResponse{
   value?: {allowedMemberTypes?: string[],description?: string,displayName?: string,id?: string,isEnabled?: boolean,origin?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphKeyCredentialCollectionResponse{
   value?: {customKeyIdentifier?: string,displayName?: string,endDateTime?: string,key?: string,keyId?: string,startDateTime?: string,type?: string,usage?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPasswordCredentialCollectionResponse{
   value?: {customKeyIdentifier?: string,displayName?: string,endDateTime?: string,hint?: string,keyId?: string,secretText?: string,startDateTime?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRequiredResourceAccessCollectionResponse{
   value?: {resourceAccess?: {id?: string,type?: string,"@odata.type"?: string,},resourceAppId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPermissionScopeCollectionResponse{
   value?: {adminConsentDescription?: string,adminConsentDisplayName?: string,id?: string,isEnabled?: boolean,origin?: string,type?: string,userConsentDescription?: string,userConsentDisplayName?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphResourceSpecificPermissionCollectionResponse{
   value?: {description?: string,displayName?: string,id?: string,isEnabled?: boolean,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAccessReviewReviewerScopeCollectionResponse{
   value?: {query?: string,queryRoot?: string,queryType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphBookingReminderCollectionResponse{
   value?: {message?: string,offset?: string,recipients?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphBookingWorkHoursCollectionResponse{
   value?: {day?: string,timeSlots?: MicrosoftGraphBookingWorkTimeSlot[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphBookingQuestionAssignmentCollectionResponse{
   value?: {isRequired?: boolean,questionId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPhysicalAddressCollectionResponse{
   value?: {city?: string,countryOrRegion?: string,postalCode?: string,state?: string,street?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSubjectRightsRequestHistoryCollectionResponse{
   value?: {changedBy?: MicrosoftGraphIdentitySet,eventDateTime?: string,stage?: MicrosoftGraphSubjectRightsRequestStage,stageStatus?: MicrosoftGraphSubjectRightsRequestStageStatus,type?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSubjectRightsRequestStageDetailCollectionResponse{
   value?: {error?: MicrosoftGraphPublicError,stage?: MicrosoftGraphSubjectRightsRequestStage,status?: MicrosoftGraphSubjectRightsRequestStageStatus,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAssignedLabelCollectionResponse{
   value?: {displayName?: string,labelId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphAlertDetectionCollectionResponse{
   value?: {detectionType?: string,method?: string,name?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCloudAppSecurityStateCollectionResponse{
   value?: {destinationServiceIp?: string,destinationServiceName?: string,riskScore?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphFileSecurityStateCollectionResponse{
   value?: {fileHash?: MicrosoftGraphFileHash,name?: string,path?: string,riskScore?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAlertHistoryStateCollectionResponse{
   value?: {appId?: string,assignedTo?: string,comments?: string[],feedback?: MicrosoftGraphAlertFeedback,status?: MicrosoftGraphAlertStatus,updatedDateTime?: string,user?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphHostSecurityStateCollectionResponse{
   value?: {fqdn?: string,isAzureAdJoined?: boolean,isAzureAdRegistered?: boolean,isHybridAzureDomainJoined?: boolean,netBiosName?: string,os?: string,privateIpAddress?: string,publicIpAddress?: string,riskScore?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphInvestigationSecurityStateCollectionResponse{
   value?: {name?: string,status?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphMalwareStateCollectionResponse{
   value?: {category?: string,family?: string,name?: string,severity?: string,wasRunning?: boolean,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphMessageSecurityStateCollectionResponse{
   value?: {connectingIP?: string,deliveryAction?: string,deliveryLocation?: string,directionality?: string,internetMessageId?: string,messageFingerprint?: string,messageReceivedDateTime?: string,messageSubject?: string,networkMessageId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphProcessCollectionResponse{
   value?: {accountName?: string,commandLine?: string,createdDateTime?: string,fileHash?: MicrosoftGraphFileHash,integrityLevel?: MicrosoftGraphProcessIntegrityLevel,isElevated?: boolean,name?: string,parentProcessCreatedDateTime?: string,parentProcessId?: number,parentProcessName?: string,path?: string,processId?: number,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRegistryKeyStateCollectionResponse{
   value?: {hive?: MicrosoftGraphRegistryHive,key?: string,oldKey?: string,oldValueData?: string,oldValueName?: string,operation?: MicrosoftGraphRegistryOperation,processId?: number,valueData?: string,valueName?: string,valueType?: MicrosoftGraphRegistryValueType,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecurityResourceCollectionResponse{
   value?: {resource?: string,resourceType?: MicrosoftGraphSecurityResourceType,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAlertTriggerCollectionResponse{
   value?: {name?: string,type?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphUriClickSecurityStateCollectionResponse{
   value?: {clickAction?: string,clickDateTime?: string,id?: string,sourceId?: string,uriDomain?: string,verdict?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphVulnerabilityStateCollectionResponse{
   value?: {cve?: string,severity?: string,wasRunning?: boolean,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphComplianceInformationCollectionResponse{
   value?: {certificationControls?: MicrosoftGraphCertificationControl[],certificationName?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSecureScoreControlStateUpdateCollectionResponse{
   value?: {assignedTo?: string,comment?: string,state?: string,updatedBy?: string,updatedDateTime?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAverageComparativeScoreCollectionResponse{
   value?: {averageScore?: number | string,basis?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphControlScoreCollectionResponse{
   value?: {controlCategory?: string,controlName?: string,description?: string,score?: number | string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphIdentitySetCollectionResponse{
   value?: {application?: MicrosoftGraphIdentity,device?: MicrosoftGraphIdentity,user?: MicrosoftGraphIdentity,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphUserAttributeValuesItemCollectionResponse{
   value?: {isDefault?: boolean,name?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCertificateAuthorityCollectionResponse{
   value?: {certificate?: string,certificateRevocationListUrl?: string,deltaCertificateRevocationListUrl?: string,isRootAuthority?: boolean,issuer?: string,issuerSki?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAlternativeSecurityIdCollectionResponse{
   value?: {identityProvider?: string,key?: string,type?: number,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSettingTemplateValueCollectionResponse{
   value?: {defaultValue?: string,description?: string,name?: string,type?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphVerifiedDomainCollectionResponse{
   value?: {capabilities?: string,isDefault?: boolean,isInitial?: boolean,name?: string,type?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPhysicalOfficeAddressCollectionResponse{
   value?: {city?: string,countryOrRegion?: string,officeLocation?: string,postalCode?: string,state?: string,street?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphUnifiedRolePermissionCollectionResponse{
   value?: {allowedResourceActions?: string[],condition?: string,excludedResourceActions?: string[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRubricLevelCollectionResponse{
   value?: {description?: MicrosoftGraphEducationItemBody,displayName?: string,grading?: MicrosoftGraphEducationAssignmentGradeType,levelId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRubricQualityCollectionResponse{
   value?: {criteria?: MicrosoftGraphRubricCriterion[],description?: MicrosoftGraphEducationItemBody,displayName?: string,qualityId?: string,weight?: number | string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRelatedContactCollectionResponse{
   value?: {accessConsent?: boolean,displayName?: string,emailAddress?: string,mobilePhone?: string,relationship?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRubricQualityFeedbackModelCollectionResponse{
   value?: {feedback?: MicrosoftGraphEducationItemBody,qualityId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRubricQualitySelectedColumnModelCollectionResponse{
   value?: {columnId?: string,qualityId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphWorkbookSortFieldCollectionResponse{
   value?: {ascending?: boolean,color?: string,dataOption?: string,icon?: MicrosoftGraphWorkbookIcon,key?: number,sortOn?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCalendarSharingMessageActionCollectionResponse{
   value?: {action?: MicrosoftGraphCalendarSharingAction,actionType?: MicrosoftGraphCalendarSharingActionType,importance?: MicrosoftGraphCalendarSharingActionImportance,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphDocumentSetVersionItemCollectionResponse{
   value?: {itemId?: string,title?: string,versionId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphExtensionSchemaPropertyCollectionResponse{
   value?: {name?: string,type?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCallRouteCollectionResponse{
   value?: {final?: {application?: MicrosoftGraphIdentity,device?: MicrosoftGraphIdentity,user?: MicrosoftGraphIdentity,"@odata.type"?: string,},original?: {application?: MicrosoftGraphIdentity,device?: MicrosoftGraphIdentity,user?: MicrosoftGraphIdentity,"@odata.type"?: string,},routingType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphInvitationParticipantInfoCollectionResponse{
   value?: {hidden?: boolean,identity?: {application?: MicrosoftGraphIdentity,device?: MicrosoftGraphIdentity,user?: MicrosoftGraphIdentity,"@odata.type"?: string,},participantId?: string,removeFromDefaultAudioRoutingGroup?: boolean,replacesCallId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphAccessReviewNotificationRecipientItemCollectionResponse{
   value?: {notificationRecipientScope?: MicrosoftGraphAccessReviewNotificationRecipientScope,notificationTemplateType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAccessReviewStageSettingsCollectionResponse{
   value?: {decisionsThatWillMoveToNextStage?: string[],dependsOn?: string[],durationInDays?: number,fallbackReviewers?: MicrosoftGraphAccessReviewReviewerScope[],recommendationsEnabled?: boolean,reviewers?: MicrosoftGraphAccessReviewReviewerScope[],stageId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAppConsentRequestScopeCollectionResponse{
   value?: {displayName?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphWindowsInformationProtectionResourceCollectionCollectionResponse{
   value?: {displayName?: string,resources?: string[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphWindowsInformationProtectionIPRangeCollectionCollectionResponse{
   value?: {displayName?: string,ranges?: {"@odata.type"?: string,},"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphWindowsInformationProtectionProxiedDomainCollectionCollectionResponse{
   value?: {displayName?: string,proxiedDomains?: {ipAddressOrFQDN?: string,proxy?: string,"@odata.type"?: string,},"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphWindowsInformationProtectionAppCollectionResponse{
   value?: {denied?: boolean,description?: string,displayName?: string,productName?: string,publisherName?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAppConfigurationSettingItemCollectionResponse{
   value?: {appConfigKey?: string,appConfigKeyType?: string,appConfigKeyValue?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphWin32LobAppReturnCodeCollectionResponse{
   value?: {returnCode?: number,type?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphWin32LobAppRuleCollectionResponse{
   value?: {ruleType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphComplianceManagementPartnerAssignmentCollectionResponse{
   value?: {target?: MicrosoftGraphDeviceAndAppManagementAssignmentTarget,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRolePermissionCollectionResponse{
   value?: {resourceActions?: MicrosoftGraphResourceAction[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphOmaSettingCollectionResponse{
   value?: {description?: string,displayName?: string,omaUri?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAppListItemCollectionResponse{
   value?: {appId?: string,appStoreUrl?: string,name?: string,publisher?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphIosHomeScreenPageCollectionResponse{
   value?: {displayName?: string,icons?: {displayName?: string,"@odata.type"?: string,},"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphIosNotificationSettingsCollectionResponse{
   value?: {alertType?: string,appName?: string,badgesEnabled?: boolean,bundleID?: string,enabled?: boolean,publisher?: string,showInNotificationCenter?: boolean,showOnLockScreen?: boolean,soundsEnabled?: boolean,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphIosNetworkUsageRuleCollectionResponse{
   value?: {cellularDataBlocked?: boolean,cellularDataBlockWhenRoaming?: boolean,managedApps?: MicrosoftGraphAppListItem[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphManagedAppPolicyDeploymentSummaryPerAppCollectionResponse{
   value?: {configurationAppliedUserCount?: number,mobileAppIdentifier?: MicrosoftGraphMobileAppIdentifier,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphServiceHealthIssuePostCollectionResponse{
   value?: {createdDateTime?: string,description?: MicrosoftGraphItemBody,postType?: MicrosoftGraphPostType,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSharingDetailCollectionResponse{
   value?: {sharedBy?: MicrosoftGraphInsightIdentity,sharedDateTime?: string,sharingReference?: MicrosoftGraphResourceReference,sharingSubject?: string,sharingType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphShiftAvailabilityCollectionResponse{
   value?: {recurrence?: MicrosoftGraphPatternedRecurrence,timeSlots?: MicrosoftGraphTimeRange[],timeZone?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAttendanceIntervalCollectionResponse{
   value?: {durationInSeconds?: number,joinDateTime?: string,leaveDateTime?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphMediaStreamCollectionResponse{
   value?: {direction?: string,label?: string,mediaType?: string,serverMuted?: boolean,sourceId?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphChatMessageAttachmentCollectionResponse{
   value?: {content?: string,contentType?: string,contentUrl?: string,id?: string,name?: string,thumbnailUrl?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphChatMessageMentionCollectionResponse{
   value?: {id?: number,mentioned?: MicrosoftGraphChatMessageMentionedIdentitySet,mentionText?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphChatMessageReactionCollectionResponse{
   value?: {createdDateTime?: string,reactionType?: string,user?: MicrosoftGraphChatMessageReactionIdentitySet,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPreAuthorizedApplicationCollectionResponse{
   value?: {appId?: string,delegatedPermissionIds?: string[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphOptionalClaimCollectionResponse{
   value?: {additionalProperties?: string[],essential?: boolean,name?: string,source?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphResourceAccessCollectionResponse{
   value?: {id?: string,type?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRedirectUriSettingsCollectionResponse{
   value?: {index?: number,uri?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphExcludeTargetCollectionResponse{
   value?: {id?: string,targetType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse{
   value?: {id?: string,targetedAuthenticationMethod?: string,targetType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphBookingQuestionAnswerCollectionResponse{
   value?: {answer?: string,answerInputType?: MicrosoftGraphAnswerInputType,answerOptions?: string[],isRequired?: boolean,question?: string,questionId?: string,selectedOptions?: string[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphBookingWorkTimeSlotCollectionResponse{
   value?: {endTime?: string,startTime?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAvailabilityItemCollectionResponse{
   value?: {endDateTime?: {dateTime?: string,timeZone?: string,"@odata.type"?: string,},serviceId?: string,startDateTime?: {dateTime?: string,timeZone?: string,"@odata.type"?: string,},status?: MicrosoftGraphBookingsAvailabilityStatus,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPublicErrorDetailCollectionResponse{
   value?: {code?: string,message?: string,target?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphPkcs12CertificateInformationCollectionResponse{
   value?: {isActive?: boolean,notAfter?: number,notBefore?: number,thumbprint?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCrossTenantAccessPolicyTargetCollectionResponse{
   value?: {target?: string,targetType?: MicrosoftGraphCrossTenantAccessPolicyTargetType,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphResourcePermissionCollectionResponse{
   value?: {type?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphRubricCriterionCollectionResponse{
   value?: {description?: MicrosoftGraphEducationItemBody,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphAttendeeAvailabilityCollectionResponse{
   value?: {attendee?: MicrosoftGraphAttendeeBase,availability?: MicrosoftGraphFreeBusyStatus,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphMeetingTimeSuggestionCollectionResponse{
   value?: {attendeeAvailability?: MicrosoftGraphAttendeeAvailability[],confidence?: number | string,locations?: MicrosoftGraphLocation[],meetingTimeSlot?: MicrosoftGraphTimeSlot,order?: number,organizerAvailability?: MicrosoftGraphFreeBusyStatus,suggestionReason?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphTimeSlotCollectionResponse{
   value?: {end?: {dateTime?: string,timeZone?: string,"@odata.type"?: string,},start?: {dateTime?: string,timeZone?: string,"@odata.type"?: string,},"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphScheduleItemCollectionResponse{
   value?: {end?: MicrosoftGraphDateTimeTimeZone,isPrivate?: boolean,location?: string,start?: MicrosoftGraphDateTimeTimeZone,status?: MicrosoftGraphFreeBusyStatus,subject?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphDisplayNameLocalizationCollectionResponse{
   value?: {displayName?: string,languageTag?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphContentTypeInfoCollectionResponse{
   value?: {id?: string,name?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphDocumentSetContentCollectionResponse{
   value?: {contentType?: MicrosoftGraphContentTypeInfo,fileName?: string,folderName?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphAccessPackageApprovalStageCollectionResponse{
   value?: {durationBeforeAutomaticDenial?: string,durationBeforeEscalation?: string,escalationApprovers?: MicrosoftGraphSubjectSet[],fallbackEscalationApprovers?: MicrosoftGraphSubjectSet[],fallbackPrimaryApprovers?: MicrosoftGraphSubjectSet[],isApproverJustificationRequired?: boolean,isEscalationEnabled?: boolean,primaryApprovers?: MicrosoftGraphSubjectSet[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSettingSourceCollectionResponse{
   value?: {displayName?: string,id?: string,sourceType?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphIosHomeScreenFolderPageCollectionResponse{
   value?: {apps?: MicrosoftGraphIosHomeScreenApp[],displayName?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphProxiedDomainCollectionResponse{
   value?: {ipAddressOrFQDN?: string,proxy?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphResourceActionCollectionResponse{
   value?: {allowedResourceActions?: string[],notAllowedResourceActions?: string[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphBucketAggregationRangeCollectionResponse{
   value?: {from?: string,to?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAlteredQueryTokenCollectionResponse{
   value?: {length?: number,offset?: number,suggestion?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSearchBucketCollectionResponse{
   value?: {aggregationFilterToken?: string,count?: number,key?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSearchAggregationCollectionResponse{
   value?: {buckets?: MicrosoftGraphSearchBucket[],field?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSearchHitCollectionResponse{
   value?: {contentSource?: string,hitId?: string,rank?: number,resultTemplateId?: string,summary?: string,resource?: MicrosoftGraphEntity,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphAggregationOptionCollectionResponse{
   value?: {bucketDefinition?: {isDescending?: boolean,minimumCount?: number,prefixFilter?: string,ranges?: MicrosoftGraphBucketAggregationRange[],sortBy?: string,"@odata.type"?: string,},field?: string,size?: number,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSortPropertyCollectionResponse{
   value?: {isDescending?: boolean,name?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphSearchHitsContainerCollectionResponse{
   value?: {aggregations?: MicrosoftGraphSearchAggregation[],hits?: MicrosoftGraphSearchHit[],moreResultsAvailable?: boolean,total?: number,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphUnifiedApprovalStageCollectionResponse{
   value?: {approvalStageTimeOutInDays?: number,escalationApprovers?: MicrosoftGraphSubjectSet[],escalationTimeInMinutes?: number,isApproverJustificationRequired?: boolean,isEscalationEnabled?: boolean,primaryApprovers?: MicrosoftGraphSubjectSet[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphIntegerRangeCollectionResponse{
   value?: {end?: number,start?: number,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCertificationControlCollectionResponse{
   value?: {name?: string,url?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCommsNotificationCollectionResponse{
   value?: {changeType?: string,resourceUrl?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphMeetingParticipantInfoCollectionResponse{
   value?: {identity?: MicrosoftGraphIdentitySet,role?: MicrosoftGraphOnlineMeetingRole,upn?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphMediaInfoCollectionResponse{
   value?: {resourceId?: string,uri?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphTeleconferenceDeviceMediaQualityCollectionResponse{
   value?: {averageInboundJitter?: string,averageInboundPacketLossRateInPercentage?: number | string,averageInboundRoundTripDelay?: string,averageOutboundJitter?: string,averageOutboundPacketLossRateInPercentage?: number | string,averageOutboundRoundTripDelay?: string,channelIndex?: number,inboundPackets?: number,localIPAddress?: string,localPort?: number,maximumInboundJitter?: string,maximumInboundPacketLossRateInPercentage?: number | string,maximumInboundRoundTripDelay?: string,maximumOutboundJitter?: string,maximumOutboundPacketLossRateInPercentage?: number | string,maximumOutboundRoundTripDelay?: string,mediaDuration?: string,networkLinkSpeedInBytes?: number,outboundPackets?: number,remoteIPAddress?: string,remotePort?: number,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphCallParticipantInfoCollectionResponse{
   value?: {participant?: MicrosoftGraphIdentitySet,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphShiftActivityCollectionResponse{
   value?: {code?: string,displayName?: string,endDateTime?: string,isPaid?: boolean,startDateTime?: string,theme?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export interface MicrosoftGraphTermStoreLocalizedNameCollectionResponse{
   value?: {languageTag?: string,name?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphTermStoreLocalizedDescriptionCollectionResponse{
   value?: {description?: string,languageTag?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphTermStoreLocalizedLabelCollectionResponse{
   value?: {isDefault?: boolean,languageTag?: string,name?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCallRecordsMediaCollectionResponse{
   value?: {calleeDevice?: MicrosoftGraphCallRecordsDeviceInfo,calleeNetwork?: MicrosoftGraphCallRecordsNetworkInfo,callerDevice?: MicrosoftGraphCallRecordsDeviceInfo,callerNetwork?: MicrosoftGraphCallRecordsNetworkInfo,label?: string,streams?: MicrosoftGraphCallRecordsMediaStream[],"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCallRecordsMediaStreamCollectionResponse{
   value?: {audioCodec?: MicrosoftGraphCallRecordsAudioCodec,averageAudioDegradation?: number | string,averageAudioNetworkJitter?: string,averageBandwidthEstimate?: number,averageJitter?: string,averagePacketLossRate?: number | string,averageRatioOfConcealedSamples?: number | string,averageReceivedFrameRate?: number | string,averageRoundTripTime?: string,averageVideoFrameLossPercentage?: number | string,averageVideoFrameRate?: number | string,averageVideoPacketLossRate?: number | string,endDateTime?: string,lowFrameRateRatio?: number | string,lowVideoProcessingCapabilityRatio?: number | string,maxAudioNetworkJitter?: string,maxJitter?: string,maxPacketLossRate?: number | string,maxRatioOfConcealedSamples?: number | string,maxRoundTripTime?: string,packetUtilization?: number,postForwardErrorCorrectionPacketLossRate?: number | string,startDateTime?: string,streamDirection?: string,streamId?: string,videoCodec?: MicrosoftGraphCallRecordsVideoCodec,wasMediaBypassed?: boolean,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphCallRecordsTraceRouteHopCollectionResponse{
   value?: {hopCount?: number,ipAddress?: string,roundTripTime?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphExternalConnectorsAclCollectionResponse{
   value?: {accessType?: string,type?: string,value?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
export interface MicrosoftGraphExternalConnectorsPropertyCollectionResponse{
   value?: {aliases?: string[],isQueryable?: boolean,isRefinable?: boolean,isRetrievable?: boolean,isSearchable?: boolean,labels?: MicrosoftGraphExternalConnectorsLabel[],name?: string,type?: string,"@odata.type"?: string,}
   "@odata.nextLink"?: string
}
...
export type MicrosoftGraphBookingStaffRole = "guest" | "administrator" | "viewer" | "externalGuest" | "unknownFutureValue"
